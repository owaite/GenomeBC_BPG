...
Ideal site conditions and considerations when selecting sites prior to undertaking a drone-based phenotyping trial:
**Ideal sites:**
Ideal remote sensing sites are on well maintained, relatively flat ground with juvenile trees, just before the tree crowns begin encroaching on each other.  At this stage, competition between trees will not play a significant role, allowing for clearer data collection and analysis.  Douglas-fir trees at 4m tall on sites established at 2m spacing are a good example. The imagery below is of a five-year-old Douglas fir trial.
...
##Age of sites: 
Mature sites that have not been previously georeferenced or recently measured and have reached crown closure require significantly more manual editing to create and clean up delineated crowns.  For example, a 5-year-old site with 2500 trees took 2 days of manual processing to create and clean delineated tree crowns. At a site with a similar number of trees at age 25, manual editing of delineated crowns took just over a week as there were many more instances of neighbouring branches intruding on delineated crowns. See the chapters on georeferencing and crown delineation for detailed workflows.
At mature sites where crown closure has occurred, competition can reduce the number of small trees that are visible in imagery.  At the mature East main Douglas fir site an on the ground Spring 2022 survey found 1612 live trees on site.  We were only able to produce crowns for 1514 of them and another 96 trees were partially obscured in the imagery.
Young sites with small, thin trees may reduce confidence in extracted values from within the delineated crown area. At a 3-year-old Douglas-fir trial, for example, a small number of trees under 1m were difficult to identify and delineate from nearby brush. Their canopies were also thin, reducing confidence that reflectance values within the crown delineation polygon belong entirely to the tree’s foliage or to the brush/ground below. Similar concerns were observed for western redcedar trees under 1.5m. The ability to assess younger trees would be valuable, but further experimentation would be required. The ideal conditions for our team’s project objectives were Douglas-fir sites at 5 years and western redcedar sites at 10 years after establishment.
...
Take-off/landing safety:
The area designated for take-off and landing should be free of overhanging branches and surrounding large trees, which could create safety issues.
Multispectral panel calibration:
Multispectral sensors require calibration photos to be taken. These photos are required to be acquired in as large an open area as possible so that the data collected by the DLS correctly mimics the flight conditions. Panel Calibration procedures are detailed in the SOP_MS_field document.
For RTK flight: 
The Remote Control (RC) and base station are connected via Wi-Fi for RTK flight.  The effective range of this Wi-Fi requires set up near the landing zone and a clear skyline so connectivity can be established and maintained throughout the flight.  
Should not be on a major road:
Dust and traffic create difficulties, as do bystanders.
