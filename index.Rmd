...
knitr::include_graphics("C:\\Users\\owaite\\OneDrive - NRCan RNCan\\Documents\\GitHub\\GenomeBC_BPG\\Photos_&_gifs\\Aerial_P1.PNG")
```

Date last updated: `r Sys.Date()`


<font size="2"> *"Jake King^1^, Olivia Waite^1^, Alex Liu^1^, Miriam Isaac-Renton^1^, Nicholas C. Coops^2^, Samuel Grubinger^2^, Liam Irwin^2^, Lise Van Der Merwe^3^, Jon Degner^3^, Alvin Yanchuk^3^"* 
...
^3^ BC Ministry of Forests, Cowichan Lake Research Station, 7060 Forestry Rd, Mesachie Lake, BC V0R 2N0. 2</font>
