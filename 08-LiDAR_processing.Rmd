...
The normalized tiles were then segmented to only retain the top 25% of each tree. This was done using a shapefile (.shp) containing a polygon for each tree crown, see the chapter on [crown segmentation](09-Crown_segmentation#Crown-segmentation) for a detailed workflow showing how to create crown polygons. 
