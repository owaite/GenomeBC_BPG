...
2) Does the scattered: direct ratio make sense for the lighting conditions of that day?

3) Does the magnitude of irradiance values make sense?

4) Do the relationships between direct and horizontal irradiance make sense?
...
This data was captured on June 25th, 2024 on Vancouver Island in British Columbia, Canada. As seen by the black horizontal line, the solar zenith angle at the time of the flight was around 30°. 



****************EXPLAIN solar zenith and how the sun sensor anlge should be close to it:::
...
**************************Explain sun sensor anlges dependence on flight lines 
...
**************** explain change in solar zenith over seasons and over the day ie why we need to fly +/- 2 hours from solar noon for shadows:
...
******* therefore uncorrected SSA look ok? 

********* graph of corrected and uncorrected SSA next to plot layout colored by flight lines and turns
