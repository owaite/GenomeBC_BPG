...
```{r cal-ref-agisoft, echo=FALSE, out.width="100%", fig.cap = "Calibrate reflectance tool found under Tools in Metashape."}
...
```{r cal-ref-sunPanel-agisoft, echo=FALSE, out.width="100%", fig.cap = "Calibrate reflectance tool found under Tools in Metashape with sun sensor and reflectance panels enabled for calibration."}
...
```{r align-photo-agisoft, echo=FALSE, out.width="60%", fig.cap = "Photogrametric camera alignment settings using the alignment tool in Metashape"}
...
```{r sparseCloud-agisoft, echo=FALSE, out.width="60%", fig.cap = "Sparse cloud created in image alignment. Pink points are those selected by the Gradual Selection tool that have a reconstruction uncertainty greater than or equal to 30.4608. These points will be filtered out."}
...
```{r opt-align-agisoft, echo=FALSE, out.width="60%", fig.cap = "Settings used for the Optimize Camera Alignment tool"}
...
```
```{r chunk-align-agisoft, echo=FALSE, out.width="60%", fig.cap = "Settings used for point based chunk alignment when aligning the multispectral data to the P1."}
...
```
```{r DC-settings-agisoft, echo=FALSE, out.width="60%", fig.cap = " ."}
