...
```
    ...
    - Optimize Camera Alignment at stock with fit additional corrections and estimate tiepoint covariance.
      - Finall using the select tool we manually clip any edge points not cohesive to the flight.
...
Figure \@ref(fig:chunk-align-agisoft)
...
Figure \@ref(fig:DC-settings-agisoft)     
...
Agisoft LLC. (2024). [Agisoft Metashape User Manual: Professional Edition, Version 2.1.](https://www.agisoft.com/downloads/user-manuals/)
...
Processing Multi-spectral Imagery with Agisoft MetaShape Pro:Dr. Eric Saczuk
