...
unique_id <- "treeID" # change this to the unique ID you have per tree
...
# Create a buffer around each centroid with a radius of 10cm (0.1 meters)
...
ttops_zq99 <- left_join(ttops_buffered, extracted_values, by = c(unique_id))
...
```{r prop-cirlce-crowns, echo=FALSE,fig.align = 'center',out.width="60%", fig.cap= "                 "}
...
```{r seg-parts, echo=FALSE,fig.align = 'center',out.width="60%", fig.cap= "                 "}
...
```{r seg-intersection, echo=FALSE,fig.align = 'center',out.width="60%", fig.cap= "                 "}
...
```{r seg-initial, echo=FALSE,fig.align = 'center',out.width="60%", fig.cap= "                 "}
knitr::include_graphics(here("Photos_&_gifs\\seg_initial_Crowndelin.PNG"))
```
```{r seg-centroids, echo=FALSE,fig.align = 'center',out.width="60%", fig.cap= "                 "}
knitr::include_graphics(here("Photos_&_gifs\\seg_centroids_Crowndelin.PNG"))
```

```{r seg-keep, echo=FALSE,fig.align = 'center',out.width="60%", fig.cap= "                 "}
knitr::include_graphics(here("Photos_&_gifs\\seg_keep_outline_Crowndelin.PNG"))
```


```{r seg-merge, echo=FALSE,fig.align = 'center',out.width="60%", fig.cap= "                 "}
knitr::include_graphics(here("Photos_&_gifs\\seg_merge_Crowndelin.PNG"))
```

```{r seg-merge-smooth, echo=FALSE,fig.align = 'center',out.width="60%", fig.cap= "                 "}
knitr::include_graphics(here("Photos_&_gifs\\seg_merge_smooth_Crowndelin.PNG"))
```
```{r seg-merge-smooth-np, echo=FALSE,fig.align = 'center',out.width="60%", fig.cap= "                 "}
knitr::include_graphics(here("Photos_&_gifs\\seg_merge_smooth_NMP_Crowndelin.PNG"))
```
```{r crown-seg, echo=FALSE,fig.align = 'center',out.width="60%", fig.cap= "                 "}
knitr::include_graphics(here("Photos_&_gifs\\seg_crowns_Crowndelin.PNG"))
```
```{r crown-circ, echo=FALSE,fig.align = 'center',out.width="60%", fig.cap= "                 "}
